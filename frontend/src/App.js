  ...
  const lightTheme = createTheme(
    {
      ...
      palette: {
        primary: { main: system.color.lightTheme.palette.primary || "#00a3f5" },
        secondary: { main: system.color.lightTheme.palette.secondary || "#98c3d9" },
        toolbar: { main: system.color.lightTheme.toolbar.background || "#00a3f5" },
  ...
  const darkTheme = createTheme(
    {
      ...
      palette: {
        primary: { main: system.color.darkTheme.palette.primary || "#1E90FF" },
        secondary: { main: system.color.darkTheme.palette.secondary || "#1E90FF" },
        toolbar: { main: system.color.darkTheme.toolbar.background || "#1E90FF" },
        menuItens: { main: system.color.darkTheme.menuItens || "#1E90FF" },
        ...
        text: {
          primary: system.color.darkTheme.palette.text.primary || "#1E90FF",
